...
const PerformanceDashboard = () => {
  ...
  return (
    <div className="performance-dashboard w-full flex justify-center px-3 sm:px-4 py-4 sm:py-6">
      <div className="max-w-6xl w-full flex flex-col items-center"> {/* Increased max-width */}

        {/* Header */}
        <h1
          className="font-extrabold text-3xl sm:text-4xl md:text-6xl mb-6 sm:mb-10 text-center"
          style={{
            color: '#000000',
        ...
        <div style={cardStyle} className="w-full">
          ...
          <div className="flex flex-col sm:flex-row flex-wrap gap-3 sm:gap-4 justify-center items-stretch sm:items-center w-full">
            <select
              onChange={handleAlgorithmSelect}
              className="form-input w-full sm:w-auto px-4 py-2 rounded border border-gray-300 dark:border-gray-600"
