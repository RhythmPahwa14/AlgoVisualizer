...
const GraphEulerianCircuit = () => {
  ...
  return (
    <div className="theme-container" data-aos="fade-up" data-aos-duration="1000">
      <h1 className="theme-title">Eulerian Circuit</h1>
      <p style={{ textAlign: 'center', maxWidth: '700px', margin: '-2rem auto 2rem auto', color: 'var(--theme-text-secondary)' }}>
        ...
        This visualizer uses <strong>Hierholzer's algorithm</strong> to find an Eulerian circuit.
        <br/><br/>
      ...
      <div className="theme-card" style={{ marginTop: '2rem' }} data-aos="fade-up" data-aos-delay="400">
        ...
        <div style={{ 
          ...
          <strong>Note:</strong> This is an implementation of Hierholzer's algorithm for finding an Eulerian Circuit in {selectedLanguage.toUpperCase()}. 
...
export default GraphEulerianCircuit;
